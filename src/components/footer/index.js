                    ...
                    <div className="row">
                            ...
                            <div className="widget about-widget">
                                    ...
                                    <div style={{display: 'flex', gap: '15px', marginTop: '20px'}}>
                                        <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" title="Facebook" style={{
                                            display: 'flex', 
                                            alignItems: 'center', 
                                        ...
                                        <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" title="Twitter" style={{
                                            display: 'flex', 
                                            alignItems: 'center', 
                                            justifyContent: 'center', 
                                            width: '40px', 
                                        ...
                                        <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" title="Instagram" style={{
                                            display: 'flex', 
                                            alignItems: 'center', 
                                            justifyContent: 'center', 
                                            width: '40px', 
                                        ...
                                        <a href="https://wa.me/03214696962" target="_blank" rel="noopener noreferrer" title="WhatsApp" style={{
                                            display: 'flex', 
                                            alignItems: 'center', 
                                            justifyContent: 'center', 
                                            width: '40px', 
                            ...
                            <div className="col col-lg-3 col-md-6 col-12">
                                <div className="widget contact-widget">
                                    ...
                                    <div className="contact-ft">
                                        <ul>
                                            <li>
                                                <span>Plot 761, Ravi Block<br />Allama Iqbal Town, Lahore, Punjab</span>
                                            </li>
                                            <li>
                                                <a href="tel:+923214696962">+92-321-4696962</a>
                                            </li>
                                            <li>
                                                <a href="mailto:info@taleemulquran.com">info@taleemulquran.com</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div className="row">
                            ...
                            <div className="col col-lg-6 col-md-6 col-12">
                                <div className="footer-links">
                                    <Link to="/about" onClick={ClickHandler}>About Us</Link>
